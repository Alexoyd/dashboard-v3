            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 flex flex-col">
                            ...
                            <a href="{{ route('admin.clients.index') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded self-start mt-auto">
                                Voir les Clients
                            </a>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 flex flex-col">
                            ...
                            <a href="{{ route('admin.legal-pages.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded self-start mt-auto">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 flex flex-col">
                            ...
                            <a href="{{ route('admin.email-templates.index') }}" class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded self-start mt-auto">
                                Gérer les Templates
                            </a>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 flex flex-col">
                            ...
                            <a href="{{ route('admin.settings.index') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded self-start mt-auto">
                                Paramètres Email
                            </a>
                        </div>
                    </div>
