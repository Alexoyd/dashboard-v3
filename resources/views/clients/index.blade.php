                                ...
                                @else
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400 mt-1">
                                            {{ $currentTab == 'questionnaire_medical' ? 'Gérez vos questionnaires de santé' : 'Gérez vos formulaires d\'adressage' }}
                                        </p>
                                    </div>
                                                        ...
                                                        <td colspan="4" class="py-12 px-6 text-center">
                                                            <div class="flex flex-col items-center">
                                                                ...
                                                                <p class="text-gray-500 dark:text-gray-400 text-lg">
                                                                    Aucun {{ $currentTab == 'questionnaire_medical' ? 'questionnaire médical' : 'formulaire d\'adressage' }} trouvé.
                                                                </p>
