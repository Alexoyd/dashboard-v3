...
<head>
    ...
    <title>Liste des questionnaires m�dicaux et formulaires d'adressage</title>
    <style>
        .red-dot {
                    ...
                    <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                        <div class="overflow-x-auto">
                            ...
                            <div class="tab-content">
                                ...
                                @else
                                    <!-- ========== ONGLET QUESTIONNAIRES M�?DICAUX ========== -->
                                    <div class="mb-6">
                                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                                             @if($currentTab == 'questionnaire_medical')
                                                �??? <span class="ml-2">Questionnaires médicaux</span>
                                            @else
                                               �?�� <span class="ml-2">Formulaire d'adressage</span>
                                            @endif
                                        </h1>
                                        <p class="text-gray-600 dark:text-gray-400 mt-1">
                                            {{ $currentTab == 'questionnaire_medical' ? 'G�rez vos questionnaires de santé' : 'G�rez vos formulaires d\'adressage' }}
                                        </p>
                                    </div>
                                                        ...
                                                        <td colspan="4" class="py-12 px-6 text-center">
                                                            <div class="flex flex-col items-center">
                                                                ...
                                                                <p class="text-gray-500 dark:text-gray-400 text-lg">
                                                                    Aucun {{ $currentTab == 'questionnaire_medical' ? 'questionnaire médical' : 'formulaire d\'adressage' }} trouv�.
                                                                </p>
